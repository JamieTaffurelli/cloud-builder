...
. (Join-Path -Path $interfaceCmdletDirectory -ChildPath "Get-AzBuildResource.ps1" -Resolve)
...
Describe "$(Split-Path -Path $PSCommandPath -Leaf)" {
    ...
    Context "Storage Context Validation" {
        ...
        Mock -CommandName Get-AzBuildResource -MockWith { @{ ResourceGroupName = "ResourceGroup"; StorageAccountName = "StorageAccount" } }
        ...
        It "Sets Storage Context with OAuth authentication as default" {
            ...
            New-AzBuildStorageContext -StorageAccountName "StorageAccount" | should be "Storage Context"
        ...
        It "Sets Storage Context with OAuth authentication if specified" {
            ...
            New-AzBuildStorageContext -StorageAccountName "StorageAccount" -AuthMethod "OAuth" | should be "Storage Context"
        ...
        It "Sets Storage Context with dynamic key authentication if specified" {
            ...
            New-AzBuildStorageContext -StorageAccountName "StorageAccount" -AuthMethod "Key" | should be "Storage Context"
            ...
            Assert-MockCalled -CommandName New-AzStorageContext -Times 1 -Scope It -Exactly
            Assert-MockCalled -CommandName Get-AzBuildResource -Times 1 -Scope It -Exactly -ParameterFilter { ($Name -eq "StorageAccount") -and ($Type -eq "Storage Account") }
            Assert-MockCalled -CommandName Get-AzBuildResource -Times 1 -Scope It -Exactly
        ...
        It "Sets Storage Context with anonymous authentication if specified" {
            ...
            New-AzBuildStorageContext -StorageAccountName "StorageAccount" -AuthMethod "Anonymous" | should be "Storage Context"
        ...
        It "Sets Storage Context with static key authentication if specified" {
            ...
            New-AzBuildStorageContext -StorageAccountName "StorageAccount" -StorageAccountKey "StorageKey" | should be "Storage Context"
        ...
        It "Sets Storage Context with static SAS token authentication if specified" {
            ...
            New-AzBuildStorageContext -StorageAccountName "StorageAccount" -SasToken "StorageSAS" | should be "Storage Context"
