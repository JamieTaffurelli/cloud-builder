...
Describe "App Service Response Time Metric Alert Parameter Validation" {
...
Describe "App Service Response Time Metric Alert Resource Validation" {

    $responseTime = $json.resources | Where-Object { $PSItem.properties.criteria.allof.metricName -eq "AverageResponseTime" }
    
    Context "type Validation" {

        It "alert type value is Microsoft.Insights/metricAlerts" {

            $responseTime.type | should be "Microsoft.Insights/metricAlerts"
        }
    }
    ...
    Context "apiVersion Validation" {
        ...
        It "alert apiVersion value is 2018-03-01" {
            ...
            $responseTime.apiVersion | should be "2018-03-01"
        }
    }
    ...
    Context "location Validation" {
        ...
        It "location value is global" {
            ...
            $responseTime.location | should be "global"
        }
    }

    Context "metricName Validation" {

        It "metricName value is AverageResponseTime" {

            $responseTime.properties.criteria.allof.metricName | should be "AverageResponseTime"
        }
    }
    ...
    Context "operator Validation" {
        ...
        It "operator value is GreaterThan" {
            ...
            $responseTime.properties.criteria.allof.operator | should be "GreaterThan"
        }
    }
    ...
    Context "timeAggregation Validation" {
        ...
        It "timeAggregation value is Total" {
            ...
            $responseTime.properties.criteria.allof.timeAggregation | should be "Total"
        }
    }
}
...
Describe "Metric Alert Output Validation" {
    ...
    $responseTime = $json.outputs.metricAlert

    Context "Response Time Metric Alert Reference Validation" {

        It "type value is object" {

            $responseTime.type | should be "object"
        }

        It "Uses full reference for Metric Alert" {

            $responseTime.value | should be "[reference(resourceId('Microsoft.Insights/metricAlerts', variables('responseTimeAlertName')), '2018-03-01', 'Full')]"
        }
    }
}