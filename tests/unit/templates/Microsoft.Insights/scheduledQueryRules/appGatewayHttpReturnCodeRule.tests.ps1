...
Describe "App Gateway HTTP Return Code Rule Parameter Validation" {
...
Describe "App Gateway HTTP Return Code Resource Validation" {
...
Describe "App Gateway HTTP Return Code Output Validation" {

    Context "App Gateway HTTP Return Code Reference Validation" {
