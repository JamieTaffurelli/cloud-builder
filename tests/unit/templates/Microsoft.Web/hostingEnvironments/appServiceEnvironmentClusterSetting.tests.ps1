...
Describe "Application Service Environment Parameter Validation" {
    ...
    Context "certificateThumbprint Validation" {

        It "Has certificateThumbprint parameter" {

            $json.parameters.certificateThumbprint | should not be $null
        }

        It "certificateThumbprint parameter is of type securestring" {

            $json.parameters.certificateThumbprint.type | should be "securestring"
        }

        It "certificateThumbprint parameter is mandatory" {

            ($json.parameters.certificateThumbprint.PSObject.Properties.Name -contains "defaultValue") | should be $false
        }
    }
...
Describe "Application Service Environment Resource Validation" {
    ...
    Context "Certificate Validation" {
        ...
        It "Thumbprint name is DefaultSslCertificateThumbprint" {

            $ase.properties.clusterSettings.name | should be "DefaultSslCertificateThumbprint"
        }
    }
