...
Describe "Automation Account Job Schedule Output Validation" {
    ...
    Context "Automation Account Job Schedule Reference Validation" {
        ...
        It "Uses full reference for Automation Account Job Schedule" {
            ...
            $json.outputs.jobSchedule.value | should be "[reference(resourceId('Microsoft.Automation/automationAccounts/jobs', parameters('automationAccountName'), parameters('jobScheduleName')), '2015-10-31', 'Full')]"
        }
    }
}