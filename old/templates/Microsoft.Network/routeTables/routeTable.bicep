...
resource routeTableName_resource 'Microsoft.Network/routeTables@2019-04-01' = {
  name: routeTableName
  location: location
  tags: tags
  properties: {
...
output routeTable object = reference(routeTableName_resource.id, '2019-04-01', 'Full')