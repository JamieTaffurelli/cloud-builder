...
resource appName_slotName 'Microsoft.Web/sites/slots@2018-11-01' = {
...
resource appName_slotName_Microsoft_Insights_service 'Microsoft.Web/sites/slots//providers/diagnosticSettings@2015-07-01' = {
  name: '${appName}/${slotName}/Microsoft.Insights/service'
  properties: {
    metrics: [
      {
        category: 'AllMetrics'
...
output slot object = reference(appName_slotName.id, '2018-11-01', 'Full')